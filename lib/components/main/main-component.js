System.register(["@angular/core", "../../services/authentication-service", "../menu/menu-component", "../../forms/usuario/index"], function (exports_1, context_1) {
    "use strict";
    ...
    var core_1, authentication_service_1, menu_component_1, index_1, MainComponent;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
                ...
                MainComponent.prototype.onMenuChanged = function (option) {
                    switch (option) {
                        ...
                        case menu_component_1.MenuOptions.FORM_USUARIO:
                            this.setCurrentComponent(index_1.UsuarioForm);
                            break;
                    }
                };
