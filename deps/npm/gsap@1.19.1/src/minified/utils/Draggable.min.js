...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
  ...
  _gsScope._gsDefine("utils.Draggable", ["events.EventDispatcher", "TweenLite", "plugins.CSSPlugin"], function(a, b, c) {
    var d,
        ...
        r = {},
        s = {style: {}},
        t = _gsScope.document || {createElement: function() {
            return s;
          }},
        u = t.documentElement || {},
        v = function(a) {
        ...
        xa = function(a) {
          ...
          if (Ta.cacheSVGData !== !1 && a._dCache && a._dCache.lastUpdate === b.ticker.frame)
            return a._dCache;
          var c,
              d,
              e,
          ...
          for (e = s.offsetParent, e === t.body && (e = u), wa.length = va.length = 0; r && (j = ia(r, oa, !0), "matrix(1, 0, 0, 1, 0, 0)" !== j && "none" !== j && "translate3d(0px, 0px, 0px)" !== j && (wa.push(r), va.push(r.style[oa]), r.style[oa] = "none"), r !== e); )
            r = r.parentNode;
          for (d = e.getBoundingClientRect(), j = a.getScreenCTM(), m = a.createSVGPoint(), l = m.matrixTransform(j), m.x = m.y = 10, m = m.matrixTransform(j), s.scaleX = (m.x - l.x) / 10, s.scaleY = (m.y - l.y) / 10, void 0 === g && la(), s.borderBox && !h && a.getAttribute("width") && (f = da(a) || {}, n = parseFloat(f.borderLeftWidth) + parseFloat(f.borderRightWidth) || 0, o = parseFloat(f.borderTopWidth) + parseFloat(f.borderBottomWidth) || 0, p = parseFloat(f.width) || 0, q = parseFloat(f.height) || 0, s.scaleX *= (p - n) / p, s.scaleY *= (q - o) / q), i ? (c = a.getBoundingClientRect(), s.offsetLeft = c.left - d.left, s.offsetTop = c.top - d.top) : (s.offsetLeft = l.x - d.left, s.offsetTop = l.y - d.top), s.offsetParent = e, k = wa.length; --k > -1; )
            wa[k].style[oa] = va[k];
          return s;
        },
        ya = function(a, c) {
        ...
        za = function(a) {
          ...
          if (d.isSVG = f, d.isSVGRoot = g, d.borderBox = "border-box" === e.boxSizing, d.computedStyle = e, g)
            c = a.parentNode || u, c.insertBefore(w, a), d.offsetParent = w.offsetParent || u, c.removeChild(w);
          else if (f) {
            for (c = a.parentNode; c && "svg" !== (c.nodeName + "").toLowerCase(); )
              c = c.parentNode;
            d.offsetParent = c;
          } else
            d.offsetParent = a.offsetParent;
          return d;
        },
        Aa = function(a, b, c, d) {
        ...
        Ba = function(a, b) {
          ...
          for (var c,
              ...
              m = Aa(a, k, l); (a = a.parentNode) && a.parentNode && a !== u; )
            k = l, l = ya(a.parentNode, k === qa ? ra : qa), i = Aa(a, k, l), c = m[0], d = m[1], e = m[2], f = m[3], g = m[4], h = m[5], m[0] = c * i[0] + d * i[2], m[1] = c * i[1] + d * i[3], m[2] = e * i[0] + f * i[2], m[3] = e * i[1] + f * i[3], m[4] = g * i[0] + h * i[2] + i[4], m[5] = g * i[1] + h * i[3] + i[5];
        ...
        Ea = function(a, b, c) {
          ...
          var d,
              ...
              B = a.getBBox && ta(a);
          if (a === window)
            g = U(), e = V(), f = e + (u.clientWidth || a.innerWidth || t.body.clientWidth || 0), h = g + ((a.innerHeight || 0) - 20 < u.clientHeight ? u.clientHeight : a.innerHeight || t.body.clientHeight || 0);
          else {
        ...
        Ga = function(a) {
          ...
          for (b = 0; f > b; b++)
            if (c = a[b], Fa(c))
              ...
              c && 0 !== c.length && e.push(c);
          return e;
        },
        Ha = "ontouchstart" in u && "orientation" in window,
        Ia = function(a) {
          for (var b = a.split(","),
              c = (void 0 !== w.onpointerdown ? "pointerdown,pointermove,pointerup,pointercancel" : void 0 !== w.onmspointerdown ? "MSPointerDown,MSPointerMove,MSPointerUp,MSPointerCancel" : a).split(","),
              d = {},
              e = 8; --e > -1; )
            d[b[e]] = c[e], d[c[e]] = b[e];
          return d;
        ...
        Oa = function(a, b, c, d, e, f) {
          ...
          if (b)
            if (1 !== e && b instanceof Array) {
              ...
              "function" == typeof b ? j.end = function(c) {
                var d,
                    f,
                    g = b.call(a, c);
        ...
        Qa = function(a, b) {
          for (var c,
              d = a.length; --d > -1; )
            c = a[d], c.ondragstart = c.onselectstart = b ? null : y, ca(c, "userSelect", b ? "text" : "none");
        },
        Ra = function() {
          var a,
        ...
        Ta = function(d, g) {
          ...
          var h,
              ...
              Za = function(a) {
                if (Ga.autoScroll && Ga.isDragging && (Va || ba)) {
                  var b,
                      ...
                      l = d,
                      m = 15 * Ga.autoScroll;
                  for (Va = !1, M.scrollTop = null != window.pageYOffset ? window.pageYOffset : null != u.scrollTop ? u.scrollTop : t.body.scrollTop, M.scrollLeft = null != window.pageXOffset ? window.pageXOffset : null != u.scrollLeft ? u.scrollLeft : t.body.scrollLeft, f = Ga.pointerX - M.scrollLeft, g = Ga.pointerY - M.scrollTop; l && !c; )
              ...
              cb = function(a, b) {
                var c,
                    ...
                    h,
                    j;
                a && f ? (a === !0 && (c = g.snap || g.liveSnap || {}, e = c instanceof Array || "function" == typeof c, a = {resistance: (g.throwResistance || g.resistance || 1e3) / (ya ? 10 : 1)}, ya ? a.rotation = Oa(Ga, e ? c : c.rotation, w, y, 1, b) : (Da && (a[za] = Oa(Ga, e ? c : c.points || c.x || c.left || c.scrollLeft, w, y, i ? -1 : 1, b || "x" === Ga.lockedAxis)), Ea && (a[Aa] = Oa(Ga, e ? c : c.points || c.y || c.top || c.scrollTop, E, H, i ? -1 : 1, b || "y" === Ga.lockedAxis)), (c.points || c instanceof Array && "object" == typeof c[0]) && (a.linkedProps = za + "," + Aa, a.radius = c.radius))), Ga.isThrowing = !0, j = isNaN(g.overshootTolerance) ? 1 === g.edgeResistance ? 0 : 1 - Ga.edgeResistance + .2 : g.overshootTolerance, Ga.tween = h = f.to(i || d, {
                  throwProps: a,
              ...
              eb = function() {
                ...
                db(!1), ma && (j = Ga.pointerX * ma[0] + Ga.pointerY * ma[2] + ma[4], k = Ga.pointerX * ma[1] + Ga.pointerY * ma[3] + ma[5]), ba && (lb(Ga.pointerX, Ga.pointerY), Za(!0)), i ? (_a(), r = i.top(), l = i.left()) : (fb() ? ($a(!0, !0), _a()) : Ga.applyBounds(), ya ? (Z = Ca(d, {
                  x: 0,
                  y: 0
                }), $a(!0, !0), l = Ga.x, r = Ga.y = Math.atan2(Z.y - Ga.pointerY, Ga.pointerX - Z.x) * z) : (oa = d.parentNode ? d.parentNode.scrollTop || 0 : 0, pa = d.parentNode ? d.parentNode.scrollLeft || 0 : 0, r = ia(d, Aa), l = ia(d, za))), s && a && (l > w ? l = w + (l - w) / a : y > l && (l = y - (y - l) / a), ya || (r > E ? r = E + (r - E) / a : H > r && (r = H - (H - r) / a))), Ga.startX = l, Ga.startY = r;
              },
              fb = function() {
              ...
              ib = function(a, b, c, d, e, f, g) {
                return f = f || A, "function" == typeof a ? function(h) {
                  ...
                  for (var c,
                      ...
                      i = 0,
                      j = A; --h > -1; )
                    e = a[h], c = e.x - b.x, d = e.y - b.y, g = Math.sqrt(c * c + d * d), j > g && (i = h, j = g);
                  return f >= j ? a[i] : b;
                } : function(a) {
                  return a;
                };
              ...
              jb = function(a) {
                ...
                if (!(!h || Ga.isPressed || !a || ("mousedown" === a.type || "pointerdown" === a.type) && B() - Ya < 30 && Ia[Ga.pointerEvent.type])) {
                  if (na = fb(), Ga.pointerEvent = a, Ia[a.type] ? (la = -1 !== a.type.indexOf("touch") ? a.currentTarget || a.target : t, Ja(la, "touchend", mb), Ja(la, "touchmove", kb), Ja(la, "touchcancel", mb), Ja(t, "touchstart", Na)) : (la = null, Ja(t, "mousemove", kb)), sa = null, Ja(t, "mouseup", mb), a && a.target && Ja(a.target, "mouseup", mb), ha = Wa.call(Ga, a.target) && !g.dragClickables)
                    return Ja(a.target, "change", mb), ja(Ga, "press", "onPress"), void Qa(Ma, !0);
                  if (ra = la && Da !== Ea && Ga.vars.allowNativeTouchScrolling !== !1 ? Da ? "y" : "x" : !1, C ? a = _(a, !0) : ra || Ga.allowEventDefault || (a.preventDefault(), a.preventManipulation && a.preventManipulation()), a.changedTouches ? (a = U = a.changedTouches[0], V = a.identifier) : a.pointerId ? V = a.pointerId : U = V = null, I++, Q(Za), k = Ga.pointerY = a.pageY, j = Ga.pointerX = a.pageX, (ra || Ga.autoScroll) && $(d.parentNode), d.parentNode && (i || Ga.autoScroll && !ya && d.parentNode._gsMaxScrollX && !D.parentNode) && !d.getBBox && (D.style.width = d.parentNode.scrollWidth + "px", d.parentNode.appendChild(D)), eb(), Ga.tween && Ga.tween.kill(), Ga.isThrowing = !1, b.killTweensOf(i || d, !0, Ra), i && b.killTweensOf(d, !0, {scrollTo: 1}), Ga.tween = Ga.lockedAxis = null, (g.zIndexBoost || !ya && !i && g.zIndexBoost !== !1) && (d.style.zIndex = Ta.zIndex++), Ga.isPressed = !0, v = !(!g.onDrag && !Ga._listeners.drag), !ya)
                    for (c = Ma.length; --c > -1; )
              ...
              kb = function(a) {
                ...
                if (h && !e && Ga.isPressed && a) {
                  ...
                  } else if (a.pointerId && V && a.pointerId !== V)
                    return;
                  if (C)
                    a = _(a, !0);
                  else {
                    if (la && ra && !sa && (c = a.pageX, d = a.pageY, ma && (f = c * ma[0] + d * ma[2] + ma[4], d = c * ma[1] + d * ma[3] + ma[5], c = f), g = Math.abs(c - j), i = Math.abs(d - k), (g !== i && (g > Fa || i > Fa) || J && ra === sa) && (sa = g > i && Da ? "x" : "y", Ga.vars.lockAxisOnTouchScroll !== !1 && (Ga.lockedAxis = "x" === sa ? "y" : "x", "function" == typeof Ga.vars.onLockAxis && Ga.vars.onLockAxis.call(Ga, l)), J && ra === sa)))
                      return void mb(l);
              ...
              mb = function(a, c) {
                if (h && Ga.isPressed && (!a || null == V || c || !(a.pointerId && a.pointerId !== V || a.changedTouches && !La(a.changedTouches, V)))) {
                  ...
                  if (la ? (Ka(la, "touchend", mb), Ka(la, "touchmove", kb), Ka(la, "touchcancel", mb), Ka(t, "touchstart", Na)) : Ka(t, "mousemove", kb), Ka(t, "mouseup", mb), a && a.target && Ka(a.target, "mouseup", mb), ba = !1, ha)
                    return a && Ka(a.target, "change", mb), Qa(Ma, !1), ja(Ga, "release", "onRelease"), ja(Ga, "click", "onClick"), void(ha = !1);
                  if (R(Za), !ya)
                    for (f = Ma.length; --f > -1; )
          ...
          da = Ta.get(this.target), da && da.kill(), this.startDrag = function(a) {
            ...
            var c,
                ...
                h,
                i,
                j = "velocity" === a && f ? a : "object" != typeof a || ya ? "start" : "element";
            ...
            if ($a(!0), _a(), s) {
              if (b = Ga.x, c = Ga.y, b > w ? b = w : y > b && (b = y), c > E ? c = E : H > c && (c = H), (Ga.x !== b || Ga.y !== c) && (e = !0, Ga.x = Ga.endX = b, ya ? Ga.endRotation = b : Ga.y = Ga.endY = c, ba = !0, Za(!0), Ga.autoScroll && !Ga.isDragging))
                for ($(d.parentNode), f = d, M.scrollTop = null != window.pageYOffset ? window.pageYOffset : null != u.scrollTop ? u.scrollTop : t.body.scrollTop, M.scrollLeft = null != window.pageXOffset ? window.pageXOffset : null != u.scrollLeft ? u.scrollLeft : t.body.scrollLeft; f && !i; )
                  i = Y(f.parentNode), h = i ? M : f.parentNode, Ea && h.scrollTop > h._gsMaxScrollY && (h.scrollTop = h._gsMaxScrollY), Da && h.scrollLeft > h._gsMaxScrollX && (h.scrollLeft = h._gsMaxScrollX), f = h;
            ...
            if ("soft" !== a) {
              for (j = Ma.length; --j > -1; )
                k = Ma[j], Ja(k, "mousedown", jb), Ja(k, "touchstart", jb), Ja(k, "click", ob, !0), ya || ca(k, "cursor", g.cursor || "move"), ca(k, "touchCallout", "none"), ca(k, "touchAction", Da === Ea ? "none" : Da ? "pan-y" : "pan-x");
              Qa(Ma, !1);
            }
            ...
            if ("soft" !== a) {
              for (b = Ma.length; --b > -1; )
                c = Ma[b], ca(c, "touchCallout", null), ca(c, "touchAction", null), Ka(c, "mousedown", jb), Ka(c, "touchstart", jb), Ka(c, "click", ob);
          ...
          }, -1 !== wa.indexOf("scroll") && (i = this.scrollProxy = new Sa(d, T({onKill: function() {
              Ga.isPressed && mb(null);
            }}, g)), d.style.overflowY = Ea && !Ha ? "auto" : "hidden", d.style.overflowX = Da && !Ha ? "auto" : "hidden", d = i.content), g.force3D !== !1 && b.set(d, {force3D: !0}), ya ? Ra.rotation = 1 : (Da && (Ra[za] = 1), Ea && (Ra[Aa] = 1)), ya ? (P = p, S = P.css, P.overwrite = !1) : xa && (P = Da && Ea ? m : Da ? n : o, S = P.css, P.overwrite = !1), this.enable();
        },
    ...
    Ua.constructor = Ta, Ua.pointerX = Ua.pointerY = Ua.startX = Ua.startY = Ua.deltaX = Ua.deltaY = 0, Ua.isDragging = Ua.isPressed = !1, Ta.version = "0.15.0", Ta.zIndex = 1e3, Ja(t, "touchcancel", function() {}), Ja(t, "contextmenu", function(a) {
      var b;
      for (b in F)
        F[b].isPressed && F[b].endDrag();
    }), Ta.create = function(a, c) {
      "string" == typeof a && (a = b.selector(a));
      for (var d = a && 0 !== a.length ? Fa(a) ? Ga(a) : [a] : [],
          e = d.length; --e > -1; )
        d[e] = new Ta(d[e], c);
      return d;
    }, Ta.get = function(a) {
    ...
    var Va = {},
        ...
        Xa = function(a, b) {
          if (a === window)
            return Va.left = Va.top = 0, Va.width = Va.right = u.clientWidth || a.innerWidth || t.body.clientWidth || 0, Va.height = Va.bottom = (a.innerHeight || 0) - 20 < u.clientHeight ? u.clientHeight : a.innerHeight || t.body.clientHeight || 0, Va;
          var c = a.pageX !== b ? {
            left: a.pageX - V(),
            top: a.pageY - U(),
            right: a.pageX - V() + 1,
  ...
  "function" == typeof define && define.amd ? define(["TweenLite", "CSSPlugin"], b) : "undefined" != typeof module && module.exports && (require('../TweenLite.min'), require('../plugins/CSSPlugin.min'), module.exports = b());
}("Draggable");
