  ...
  !function(e, t) {
    ...
    function n(e, t) {
      ...
      var o = t.substr(2),
          a = "_" + t;
      n.set = function(e) {
        if (this[a] && this.removeEventListener(o, this[a]), "function" == typeof e) {
          var t = function(t) {
            var n;
            n = e.apply(this, arguments), void 0 == n || n || t.preventDefault();
          };
          this[a] = t, this.addEventListener(o, t, !1);
        } else
          this[a] = null;
      }, n.get = function() {
        var e = this[a] || null;
        return null === e && r && r.get && (e = r.get.apply(this, arguments), e && (n.set.apply(this, [e]), "function" == typeof this.removeAttribute && this.removeAttribute(t))), this[a] || null;
      ...
      if (a)
        for (var i = 0; i < a.length; i++) {
          var s = a[i],
              c = s.data,
              u = c.handler;
          if ((c.handler === t || u.listener === t) && c.useCapturing === r && c.eventName === n)
    ...
    function a(e, t, n) {
      var r = e[Z];
      r || (r = e[Z] = []), n ? r.unshift(t) : r.push(t);
    }
    function i(e, t, n, r, i, s) {
      function c(e) {
        var t = e.data;
        return a(t.target, e, i), t.invokeAddFunc(l, e);
      }
      function u(e) {
        var t = e.data;
        return o(t.target, e.invoke, t.eventName, t.useCapturing, !0), t.invokeRemoveFunc(f, e);
      }
      void 0 === n && (n = !0), void 0 === r && (r = !1), void 0 === i && (i = !1), void 0 === s && (s = I);
      var l = O(e),
          f = O(t),
          p = !n && void 0;
      return function(t, n) {
        var a = s(t, n);
        a.useCapturing = a.useCapturing || p;
        var i = null;
        "function" == typeof a.handler ? i = a.handler : a.handler && a.handler.handleEvent && (i = function(e) {
          return a.handler.handleEvent(e);
        });
        var f = !1;
        try {
          f = a.handler && "[object FunctionWrapper]" === a.handler.toString();
        } catch (h) {
          return;
        }
        if (!i || f)
          return a.invokeAddFunc(l, a.handler);
        if (!r) {
          var d = o(a.target, a.handler, a.eventName, a.useCapturing, !1);
          if (d)
            return a.invokeAddFunc(l, d);
        }
        var v = Zone.current,
            k = a.target.constructor.name + "." + e + ":" + a.eventName;
        v.scheduleEventTask(k, i, a, c, u);
      };
    }
    function s(e, t, n) {
      void 0 === t && (t = !0), void 0 === n && (n = I);
      var r = O(e),
          a = !t && void 0;
      return function(e, t) {
        var i = n(e, t);
        i.useCapturing = i.useCapturing || a;
        var s = o(i.target, i.handler, i.eventName, i.useCapturing, !0);
        s ? s.zone.cancelTask(s) : i.invokeRemoveFunc(r, i.handler);
      };
    }
    function c(e, t, n, r) {
      return void 0 === t && (t = z), void 0 === n && (n = C), void 0 === r && (r = I), !(!e || !e[t]) && (f(e, t, function() {
        return i(t, n, !0, !1, !1, r);
      }), f(e, n, function() {
        return s(n, !0, r);
      }), !0);
    }
    ...
    function p(e, t, n, r) {
      function o(t) {
        ...
        return n.args[0] = function() {
          t.invoke.apply(this, arguments), delete c[n.handleId];
        }, n.handleId = i.apply(e, n.args), c[n.handleId] = t, t;
      }
      function a(e) {
    ...
    function h() {
      Object.defineProperty = function(e, t, n) {
        ...
        return "prototype" !== t && (n = k(e, t, n)), g(e, t, n, r);
    ...
    function d(e, t, n) {
      var r = n.configurable;
      return n = k(e, t, n), g(e, t, n, r);
    }
    function v(e, t) {
      return e && e[R] && e[R][t];
    }
    function k(e, t, n) {
      return n.configurable = !0, n.configurable || (e[R] || F(e, R, {
        writable: !0,
        value: {}
      }), e[R][t] = !0), n;
    }
    ...
    function y(e) {
      var t = [],
          n = e.wtf;
      n ? t = x.split(",").map(function(e) {
        return "HTML" + e + "Element";
      }).concat(q) : e[A] ? t.push(A) : t = q;
    ...
    function b(e) {
      var t = e.WebSocket;
      e.EventTarget || c(t.prototype), e.WebSocket = function(e, n) {
        var o,
      ...
      for (var e = function(e) {
        ...
        self.addEventListener(t, function(e) {
          ...
          for (r = o ? o.constructor.name + "." + n : "unknown." + n; o; )
            o[n] && !o[n][N] && (t = Zone.current.wrap(o[n], r), t[N] = o[n], o[n] = t), o = o.parentElement;
        }, !0);
      },
          t = 0; t < B.length; t++)
        e(t);
    ...
    function _(e) {
      if (j && "registerElement" in e.document) {
    ...
    function S(e) {
      ...
      function n(e) {
        ...
        var r = t.target[Y] = function() {
          t.target.readyState === t.target.DONE && !t.aborted && self[$] && e.invoke();
        };
        t.target.addEventListener("readystatechange", r);
        var o = t.target[J];
        return o || (t.target[J] = e), i.apply(t.target, t.args), self[$] = !0, e;
      }
      function r() {}
      function o(e) {
        var t = e.data;
    ...
    var O = (function(e) {
      ...
      function n() {
        0 === D && 0 === S.length && (e[m] ? e[m].resolve(0)[T](a) : e[b](a, 0));
      }
      function r(e) {
        n(), S.push(e);
      }
      ...
      function l(e, t, r) {
        if (e[P] === z)
          if (r instanceof F && r.hasOwnProperty(P) && r.hasOwnProperty(j) && r[P] !== z)
            f(r), l(e, r[P], r[j]);
          else if (i(r))
            r.then(u(e, t), u(e, !1));
          else {
            ...
            if (0 == o.length && t == I) {
              ...
              try {
                ...
                var c = s;
                c.rejection = r, c.promise = e, c.zone = v.current, c.task = v.currentTask, E.push(c), n();
              }
            }
          }
        return e;
      ...
      function d() {
        ...
        if (this[t("error")] = e, e.originalStack = e.stack, d[N] && e.originalStack) {
          for (var n = e.originalStack.split("\n"),
              r = w,
              o = 0; n[o] !== q && o < n.length; )
            o++;
          for (; o < n.length && r; o++) {
            var a = n[o];
            if (a.trim()) {
              var i = B.hasOwnProperty(a) && B[a];
              i === x.blackList ? (n.splice(o, 1), o--) : i === x.transition ? r.parent ? (n[o] += " [" + r.parent.zone.name + " => " + r.zone.name + "]", r = r.parent) : r = null : n[o] += " [" + r.zone.name + "]";
            }
          }
          e.stack = e.zoneAwareStack = n.join("\n");
        }
      ...
      var v = function() {
        function t(e, t) {
          this._properties = null, this._parent = e, this._name = t ? t.name || "unnamed" : "<root>", this._properties = t && t.properties || {}, this._zoneDelegate = new k(this, this._parent && this._parent._zoneDelegate, t);
        }
        return t.assertZonePatched = function() {
          ...
          void 0 === t && (t = null), void 0 === n && (n = null), void 0 === r && (r = null), w = new y(w, this);
          try {
          ...
          F = function() {
            ...
            return e.toString = function() {
              ...
              var n = new this.constructor(null),
                  r = v.current;
              return this[P] == z ? this[j].push(r, n, e, t) : p(this, r, n, e, t), n;
      ...
      if (e.Promise = F, M && (h(M), "undefined" != typeof e.fetch)) {
        var H = void 0;
        try {
          H = e.fetch();
        } catch (R) {
          H = e.fetch("about:blank");
        }
        H.then(function() {
          return null;
        }, function() {
          return null;
        }), H.constructor != M && H.constructor != F && h(H.constructor);
      }
      Promise[v.__symbol__("uncaughtPromiseErrors")] = E;
      var x;
      !function(e) {
        e[e.blackList = 0] = "blackList", e[e.transition = 1] = "transition";
      }(x || (x = {}));
      var q,
          A = e[t("Error")] = e.Error,
          B = {};
      ...
      var N = "stackRewrite",
          ...
          G = function() {
            for (var e = Object.create(null),
                ...
                r = 0; r < n.length; r++) {
              var o = n[r];
              Object.prototype.hasOwnProperty.call(t, o) && W(e, o);
            }
            var a = A.prototype;
            if (a)
              for (var i = Object.getOwnPropertyNames(a),
                  r = 0; r < i.length; r++) {
                var o = i[r];
                "constructor" !== o && "toString" !== o && "toSource" !== o && W(e, o);
              }
            return W(e, "originalStack"), W(e, "zoneAwareStack"), X(e, "toString"), X(e, "toSource"), e;
          },
          U = G(),
          K = function(e) {
            if (e === d.prototype)
            ...
            var t = Object.create(null),
                n = Object.getOwnPropertyNames(U),
                r = Object.getOwnPropertyNames(e);
            return n.forEach(function(e) {
              0 === r.filter(function(t) {
                return t === e;
              }).length && (t[e] = U[e]);
            }), t;
          };
      d.prototype = A.prototype, d[v.__symbol__("blacklistedStackFrames")] = B, d[N] = !1, A.hasOwnProperty("stackTraceLimit") && (A.stackTraceLimit = Math.max(A.stackTraceLimit, 15), Object.defineProperty(d, "stackTraceLimit", {
        get: function() {
          return A.stackTraceLimit;
        },
        set: function(e) {
          return A.stackTraceLimit = e;
        }
      })), A.hasOwnProperty("captureStackTrace") && Object.defineProperty(d, "captureStackTrace", {value: function(e, t) {
          A.captureStackTrace(e, t);
        }}), Object.defineProperty(d, "prepareStackTrace", {
        get: function() {
          return A.prepareStackTrace;
        },
        set: function(e) {
          return e && "function" == typeof e ? A.prepareStackTrace = function(t, n) {
            if (n)
          ...
          } : A.prepareStackTrace = e;
        }
      });
      var V = v.current.fork({
        name: "detect",
        ...
        onHandleError: function(e, t, n, r) {
            ...
            for (var o = r.originalStack.split(/\n/),
              ...
              if (/:\d+:\d+/.test(c)) {
                var u = c.split("(")[0].split("@")[0],
                    l = x.transition;
                if (u.indexOf("ZoneAwareError") !== -1 && (q = c), u.indexOf("runGuarded") !== -1 ? i = !0 : u.indexOf("runTask") !== -1 ? s = !0 : u.indexOf("run") !== -1 ? a = !0 : l = x.blackList, B[c] = l, a && i && s) {
                  d[N] = !0;
                  break;
                }
              }
          ...
          J = function() {
            V.run(function() {
              V.runGuarded(function() {
                throw new Error("blacklistStackFrames");
              });
            });
          };
      return V.runTask(V.scheduleMacroTask("detect", J, null, function() {
        return null;
      }, null)), e.Zone = v;
    }("object" == typeof window && window || "object" == typeof self && self || global), function(e) {
      return "__zone_symbol__" + e;
    }),
        ...
        P = !("nw" in E) && "undefined" != typeof process && "[object process]" === {}.toString.call(process),
        j = !P && !D && !("undefined" == typeof window || !window.HTMLElement),
        Z = O("eventTasks"),
        z = "addEventListener",
        ...
        L = (i(z, C), s(C), O("originalInstance")),
        F = Object[O("defineProperty")] = Object.defineProperty,
        M = Object[O("getOwnPropertyDescriptor")] = Object.getOwnPropertyDescriptor,
        H = Object.create,
        R = O("unconfigurables"),
        x = "Anchor,Area,Audio,BR,Base,BaseFont,Body,Button,Canvas,Content,DList,Directory,Div,Embed,FieldSet,Font,Form,Frame,FrameSet,HR,Head,Heading,Html,IFrame,Image,Input,Keygen,LI,Label,Legend,Link,Map,Marquee,Media,Menu,Meta,Meter,Mod,OList,Object,OptGroup,Option,Output,Paragraph,Pre,Progress,Quote,Script,Select,Source,Span,Style,TableCaption,TableCell,TableCol,Table,TableRow,TableSection,TextArea,Title,Track,UList,Unknown,Video",
        ...
        W = "set",
        X = "clear",
        G = ["alert", "prompt", "confirm"],
        U = "object" == typeof window && window || "object" == typeof self && self || global;
    p(U, W, X, "Timeout"), p(U, W, X, "Interval"), p(U, W, X, "Immediate"), p(U, "request", "cancel", "AnimationFrame"), p(U, "mozRequest", "mozCancel", "AnimationFrame"), p(U, "webkitRequest", "webkitCancel", "AnimationFrame");
    for (var K = 0; K < G.length; K++) {
      var V = G[K];
      f(U, V, function(e, t, n) {
        return function(t, r) {
          return Zone.current.run(e, U, r, n);
        };
      });
    }
    y(U), m(U), u("MutationObserver"), u("WebKitMutationObserver"), u("FileReader"), h(), _(U), S(U);
    var J = O("xhrTask"),
        Q = O("xhrSync"),
        Y = O("xhrListener"),
        $ = O("xhrScheduled");
    U.navigator && U.navigator.geolocation && t(U.navigator.geolocation, ["getCurrentPosition", "watchPosition"]);
  });
})(require('process'));
